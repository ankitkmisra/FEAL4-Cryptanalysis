/*
 *	Differential cryptanalytic attack on FEAL-4 (CPA)
 *	Ankit Kumar Misra and Kartikey Gupta (with help from http://theamazingking.com/crypto-feal.php)
 *	Course Project, Cryptography and Network Security (CS 406)
 */
...
int main(int argc, char **argv){
    ...
    cout<<"Each ciphertext generated using the keys obtained above matches the ciphertext generated by the actual encryption algorithm!\n";
